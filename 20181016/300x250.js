...
lib.ssMetadata = [
		{name:"300x250_atlas_", frames: [[328,442,139,131],[171,442,155,121],[0,433,169,124],[0,0,403,250],[405,99,43,43],[405,0,42,64],[226,252,186,188],[0,252,224,179],[405,66,17,19],[449,47,43,50],[449,0,48,45],[0,559,142,40]]}
];
...
}).prototype = getMCSymbolPrototype(lib.元件61, new cjs.Rectangle(0,0,186,188), null);
...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(147,59.4,1,1,0,0,0,92,20);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(102).to({_off:false},0).to({y:45.8,alpha:1},7,cjs.Ease.cubicOut).wait(153));
	...
	this.instance_9.setTransform(84.2,177.2,1.113,1.113,-120,0,0,25.3,34.8);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(56).to({_off:false},0).to({scaleX:1.36,scaleY:1.36,x:79.3,y:171.3,alpha:1},10,cjs.Ease.quadOut).wait(30).to({x:89.3,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 9
	this.instance_10 = new lib.元件60();
	this.instance_10.parent = this;
	this.instance_10.setTransform(155,181.5,1,1,0,0,0,112,89.5);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(48).to({_off:false},0).to({x:165,alpha:1},11,cjs.Ease.quadOut).wait(37).to({x:175,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 1
	this.instance_11 = new lib.元件57();
	this.instance_11.parent = this;
	this.instance_11.setTransform(243.7,218.4,0.118,0.118,0,0,0,215.5,218.5);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:263.7,alpha:1},11,cjs.Ease.quadOut).wait(27).to({x:289.5,alpha:0},11,cjs.Ease.quadIn).to({_off:true},1).wait(212));
	...
	this.instance_13.setTransform(150.6,45.7,1.389,1.389,0,0,0,118.5,26.1);
...
p.nominalBounds = new cjs.Rectangle(150,125,300,272);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_atlas_.png?1539672725048", id:"300x250_atlas_"}
	],
	preloads: []
};
