...
(lib.元件2 = function(mode,startPosition,loop) {
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFF100").s().p("");
	this.shape.setTransform(109.2,-3.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件2, new cjs.Rectangle(61.1,-18.7,130.4,68), null);
...
(lib._160x600 = function(mode,startPosition,loop) {
	...
	this.instance_11.setTransform(58.9,344.3,0.915,0.915,-21.7,0,0,2.9,65.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:2.8,rotation:-25.9,guide:{path:[58.9,344.3,58.9,344.5,59,344.7,59,342.9,59.6,341.1,60.7,337.5,63.8,337,64.1,336.9,64.6,336.8,66.9,336.4,70,335.8,72.6,335.9,73.6,339.3,74.1,341.3,74.6,343.2,75.4,346.3,76.1,349,76.1,348.4,77.9,345.7,80,342.6,81.7,341.8,84,340.7,86.4,340.9,89.2,341.1,90.2,342.7,91.1,344.2,92.4,350.1,92.9,353.1,93.4,355.6,94.9,351.4,96.6,346.8,99.8,337.7,100,334.9,99.9,328.2,99.9,323.6,99.9,315.1,101.2,312.1,102.6,309,104.3,308.1,104.4,308.1,108.1,307.3,110.8,306.7,112.5,308.3,114.7,310.1,114.7,315.1,114.7,319.2,114.1,324.6,113.5,330.2,113.5,331.3,113.5,334.5,113.2,343.6,111.8,349.1,111.1,351.8,110.5,354.5,110.5,354.4]}},33,cjs.Ease.quadInOut).wait(16).to({regY:65.3,scaleX:0.84,scaleY:0.84,rotation:83.4,x:80.5,y:209.8},8).to({x:99.7,y:242.7},5,cjs.Ease.cubicInOut).to({x:95.9,y:240.2},4,cjs.Ease.quadInOut).wait(30).to({alpha:0},8).to({_off:true},1).wait(157));

	// 元件 5
	this.instance_12 = new lib.元件51();
	this.instance_12.parent = this;
	this.instance_12.setTransform(70.3,392.6,0.915,0.915,0,0,0,149.9,125.1);
	...
	this.instance_14.setTransform(83.9,232.9,1.685,1.685,0,0,0,54.6,15.6);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(7).to({_off:false},0).to({regY:15.8,scaleX:1.15,scaleY:1.15,x:79.6,y:221.2},8,cjs.Ease.quadInOut).to({regX:54.7,scaleX:1.24,scaleY:1.24,x:80.4,y:223.1},5,cjs.Ease.quadInOut).to({regX:54.6,regY:15.7,scaleX:1.21,scaleY:1.21,x:80,y:222.5},4,cjs.Ease.quadInOut).wait(15).to({regX:54.7,scaleX:1.1,scaleY:1.1,x:78.6,y:223.5,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(210));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/160x600_atlas_.png?1538131738722", id:"160x600_atlas_"}
	],
	preloads: []
};
