...
lib.ssMetadata = [
		{name:"320x50_atlas_", frames: [[158,252,169,124],[0,0,403,250],[0,440,142,40],[243,458,43,43],[329,252,50,92],[381,252,42,64],[243,378,79,78],[158,378,83,83],[329,346,17,19],[324,447,43,50],[381,318,48,45],[324,378,79,67],[0,252,156,186]]}
];
...
(lib.補間動畫6 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-67.6,151.3,1,1,168);

	this.instance_1 = new lib.圖層1();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-427.2,84.1,1,1,-12);

	this.instance_2 = new lib.圖層1();
	this.instance_2.parent = this;
	this.instance_2.setTransform(-84.4,129.6,1,1,168);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-530.7,-114.9,549.8,443.6);
...
(lib.元件53 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(233.2,-84.2,0.972,0.972,2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件53, new cjs.Rectangle(228.9,-84.2,204.6,129.3), null);
...
(lib._320x50 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(91.6,26,0.544,0.544,3.5,0,0,61.7,29.8);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(107).to({_off:false},0).to({regX:61.9,regY:29.7,x:92.2,y:16},7,cjs.Ease.cubicOut).wait(148));

	// p3.png
	this.instance_3 = new lib.元件53();
	this.instance_3.parent = this;
	this.instance_3.setTransform(98.2,49.9,0.483,0.483,0,0,0,111.2,29.9);
	this.instance_3.alpha = 0;
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(109).to({_off:false},0).to({regX:111.4,scaleX:0.33,scaleY:0.33,x:131.2,y:42.3,alpha:1},7,cjs.Ease.cubicOut).to({regX:111.5,regY:30,x:131.3},1).wait(145));

	// hand.png
	this.instance_4 = new lib.元件40();
	this.instance_4.parent = this;
	this.instance_4.setTransform(270.6,31.5,0.418,0.418,0,0,0,86.2,24.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(111).to({_off:false},0).to({scaleX:0.52,scaleY:0.52,x:270.7,y:28.2,alpha:1},9,cjs.Ease.cubicOut).wait(142));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/320x50_atlas_.png?1538126926892", id:"320x50_atlas_"}
	],
	preloads: []
};
