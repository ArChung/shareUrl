...
(lib._120x600 = function(mode,startPosition,loop) {
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({rotation:-25.9,guide:{path:[42.4,314.5,42.4,314.7,42.4,314.9,42.4,313.4,42.9,311.9,43.9,309,46.3,308.5,46.6,308.4,47,308.4,48.9,308,51.4,307.5,53.6,307.6,54.4,310.4,54.8,312.1,55.2,313.6,55.9,316.2,56.4,318.4,56.4,317.9,57.9,315.7,59.6,313.1,61,312.4,62.9,311.6,64.8,311.7,67.1,311.8,67.9,313.2,68.7,314.4,69.8,319.3,70.2,321.7,70.6,323.7,71.9,320.3,73.2,316.6,75.9,309.1,76,306.8,75.9,301.3,75.9,297.6,75.9,290.6,77,288.1,78.1,285.5,79.6,284.8,79.6,284.8,82.7,284.1,84.9,283.7,86.3,285,88.1,286.5,88.1,290.6,88.1,293.9,87.6,298.4,87.1,302.9,87.1,303.8,87.1,306.5,86.8,313.9,85.7,318.4,85.2,320.6,84.6,322.9,84.6,322.8]}},33,cjs.Ease.quadInOut).wait(16).to({regY:65.7,y:323},0).to({regX:2.9,regY:65.3,scaleX:0.63,scaleY:0.63,rotation:83.4,x:61.7,y:222.9},8).to({x:76,y:247.4},5,cjs.Ease.cubicInOut).to({x:73.2,y:245.6},4,cjs.Ease.quadInOut).wait(30).to({alpha:0},8).to({_off:true},1).wait(157));
	...
	this.instance_14.setTransform(64.3,207.3,1.359,1.359,0,0,0,54.6,15.7);
	this.instance_14._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(7).to({_off:false},0).to({regX:54.7,regY:15.8,scaleX:0.93,scaleY:0.93,x:60.9,y:197.8},8,cjs.Ease.quadInOut).to({regX:54.8,scaleX:1,scaleY:1,x:61.5,y:199.3},5,cjs.Ease.quadInOut).to({regX:54.6,scaleX:0.98,scaleY:0.98,x:61.2,y:198.9},4,cjs.Ease.quadInOut).wait(15).to({regX:54.7,regY:15.7,scaleX:0.89,scaleY:0.89,x:60,y:199.6,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(210));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/120x600_atlas_.png?1538120298267", id:"120x600_atlas_"}
	],
	preloads: []
};
