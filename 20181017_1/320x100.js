...
lib.ssMetadata = [
		{name:"320x100_atlas_", frames: [[0,433,169,124],[0,0,403,250],[405,113,43,43],[405,0,42,64],[226,252,186,188],[0,252,224,179],[405,158,17,19],[449,0,43,50],[405,66,48,45],[171,442,142,40]]}
];
...
(lib.元件61 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(210.7,134.5,0.099,0.099,0,0,0,178.5,127.8);
...
}).prototype = getMCSymbolPrototype(lib.元件61, new cjs.Rectangle(0,0,228.3,188), null);
...
(lib.元件59 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(221.7,-6.3,0.644,0.644,0,0,0,124,18.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件59, new cjs.Rectangle(141.8,-18.1,159.6,23.5), null);
...
(lib.元件49 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(277.3,112.4,0.85,0.85,0,0,0,172.5,43);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFF100").s().p("");
	this.shape.setTransform(167.2,56.8);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件49, new cjs.Rectangle(41.6,24.4,382,124.2), null);
...
p.nominalBounds = new cjs.Rectangle(41.6,24.4,382,124.2);
...
(lib.元件61_1 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(59.1,71.5,1,1,0,0,0,56.1,19.6);
...
}).prototype = getMCSymbolPrototype(lib.元件61_1, new cjs.Rectangle(0,19,134.3,72.1), null);
...
(lib._320x100 = function(mode,startPosition,loop) {
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(37.5,63.4,0.802,0.802,3.5,0,0,92.2,20.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(102).to({_off:false},0).to({x:38.1,y:52.6,alpha:1},7,cjs.Ease.cubicOut).wait(153));

	// t42.png
	this.instance_3 = new lib.元件34();
	this.instance_3.parent = this;
	this.instance_3.setTransform(88.5,50.2,0.719,0.719,3.5,0,0,61.6,29.8);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(107).to({_off:false},0).to({regX:61.8,regY:29.6,x:89.3,y:36.8},7,cjs.Ease.cubicOut).wait(148));

	// p3.png
	this.instance_4 = new lib.元件53();
	this.instance_4.parent = this;
	this.instance_4.setTransform(-25.2,91.2,0.758,0.758,0,0,0,111.2,29.9);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(109).to({_off:false},0).to({regX:111.4,scaleX:0.51,scaleY:0.51,x:68.9,y:77.4,alpha:1},8,cjs.Ease.cubicOut).wait(145));

	// hand.png
	this.instance_5 = new lib.元件40();
	this.instance_5.parent = this;
	this.instance_5.setTransform(256.7,80.5,0.549,0.549,0,0,0,86.2,24.7);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(111).to({_off:false},0).to({regX:86.3,regY:24.8,scaleX:0.69,scaleY:0.69,x:256.8,y:76.2,alpha:1},9,cjs.Ease.cubicOut).wait(142));
	...
	this.instance_6.setTransform(345.2,6.2,0.534,0.534,11.2,0,0,0.2,0.1);
	...
	this.instance_7.setTransform(135.3,35.9,0.669,0.669,0,0,0,300.1,59);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(50).to({_off:false},0).to({regX:300.3,scaleX:0.44,scaleY:0.44,x:135.2,y:42.7},5,cjs.Ease.quadInOut).to({regX:300.1,regY:59.1,scaleX:0.46,scaleY:0.46,y:42.3},3,cjs.Ease.quadInOut).wait(36).to({regX:300.2,regY:59.3,alpha:0.129},6,cjs.Ease.quadInOut).to({regX:300.1,regY:59.1,alpha:0},2).to({_off:true},1).wait(159));

	// 圖層 6
	this.instance_8 = new lib.元件24();
	this.instance_8.parent = this;
	this.instance_8.setTransform(249.1,45,0.455,0.455,0,0,0,118.9,40.6);
	...
	this.instance_9.setTransform(220.2,60.4,0.506,0.506,-120,0,0,24.9,34.8);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(56).to({_off:false},0).to({regX:25.2,regY:35,scaleX:0.62,scaleY:0.62,x:218,y:57.6,alpha:1},10,cjs.Ease.quadOut).wait(30).to({x:222.5,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 9
	this.instance_10 = new lib.元件60();
	this.instance_10.parent = this;
	this.instance_10.setTransform(252.4,62.3,0.455,0.455,0,0,0,112,89.6);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(48).to({_off:false},0).to({x:256.9,alpha:1},11,cjs.Ease.quadOut).wait(37).to({x:261.5,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 10
	this.instance_11 = new lib.元件61();
	this.instance_11.parent = this;
	this.instance_11.setTransform(237.1,68.3,0.551,0.551,0,0,0,93.3,94.2);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({regX:93.2,x:242.6,alpha:1},11,cjs.Ease.quadOut).wait(27).to({x:259.1,alpha:0},11,cjs.Ease.quadIn).to({_off:true},1).wait(212));

	// t1.png
	this.instance_12 = new lib.元件2();
	this.instance_12.parent = this;
	this.instance_12.setTransform(97.5,39.3,1.146,1.146,0,0,0,118.5,26);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(4).to({_off:false},0).to({regX:118.6,regY:26.1,scaleX:0.79,scaleY:0.79,y:43.4},8,cjs.Ease.quadInOut).to({regX:118.5,regY:25.9,scaleX:0.84,scaleY:0.84,y:42.7},5,cjs.Ease.quadInOut).to({scaleX:0.83,scaleY:0.83,y:42.9},4,cjs.Ease.quadInOut).wait(16).to({regY:26.1,scaleX:0.61,scaleY:0.61,x:97.4,y:45.4,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(212));

	// bg
	this.instance_13 = new lib.元件55();
	this.instance_13.parent = this;
	this.instance_13.setTransform(160,50,0.33,0.4,0,0,0,485.1,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(262));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(160,50,359,252);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/320x100_atlas_.png?1539764629308", id:"320x100_atlas_"}
	],
	preloads: []
};
