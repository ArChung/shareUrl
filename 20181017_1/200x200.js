...
lib.ssMetadata = [
		{name:"200x200_atlas_", frames: [[328,442,139,131],[171,442,155,121],[0,433,169,124],[0,0,403,250],[405,99,43,43],[405,0,42,64],[226,252,186,188],[0,252,224,179],[405,66,17,19],[449,47,43,50],[449,0,48,45],[0,559,142,40]]}
];
...
(lib._200x200 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(190.8,17.4,0.319,0.319,0,0,0,123.9,18.5);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(35.6,13.8,0.786,0.786,0,0,0,35.6,6);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(98.6,55.8,0.794,0.794,0,0,0,92.2,20.2);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(102).to({_off:false},0).to({y:45,alpha:1},7,cjs.Ease.cubicOut).wait(153));

	// t43.png
	this.instance_3 = new lib.元件32();
	this.instance_3.parent = this;
	this.instance_3.setTransform(142.3,92.7,0.694,0.694,0,0,0,67.1,20.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(107).to({_off:false},0).to({regX:0,regY:0,x:95.7,y:72.2},7,cjs.Ease.cubicOut).wait(148));

	// t42.png
	this.instance_4 = new lib.元件34();
	this.instance_4.parent = this;
	this.instance_4.setTransform(53.1,95.3,0.694,0.694,0,0,0,61.6,29.6);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(107).to({_off:false},0).to({regY:29.7,y:89.8},7,cjs.Ease.cubicOut).wait(148));

	// p3.png
	this.instance_5 = new lib.元件53();
	this.instance_5.parent = this;
	this.instance_5.setTransform(101,128.7,1.031,1.031,0,0,0,111,29.8);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(109).to({_off:false},0).to({regX:111.1,regY:29.9,scaleX:0.69,scaleY:0.69,alpha:1},8,cjs.Ease.cubicOut).wait(145));

	// hand.png
	this.instance_6 = new lib.元件40();
	this.instance_6.parent = this;
	this.instance_6.setTransform(115.2,175.1,0.694,0.694,0,0,0,86.1,24.7);
	this.instance_6.alpha = 0;
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(111).to({_off:false},0).to({y:169.6,alpha:1},9,cjs.Ease.cubicOut).wait(142));

	// 圖層 28 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_105 = new cjs.Graphics().p("A6dWXQr6iwhBmZQhAmYKfmSQKfmRP2igQP0igL6CwQL7CwBAGXQBBGZqfGSQqfGSv2CgQniBMmpAAQnVAAmPhcg");
	var mask_graphics_106 = new cjs.Graphics().p("A5TVbQr7iwhAmYQhBmZKfmRQKgmSP1igQP1igL6CwQL7CwBAGYQBBGYqgGSQqfGSv1CgQniBMmqAAQnUAAmPhcg");
	var mask_graphics_107 = new cjs.Graphics().p("A5UUfQr6ivhAmZQhBmZKfmRQKgmSP1igQP1igL6CwQL7CwBAGZQBBGXqgGSQqfGTv1CfQniBNmqAAQnUAAmQhdg");
	var mask_graphics_108 = new cjs.Graphics().p("A5UTkQr6iwhAmZQhBmYKfmSQKgmRP1igQP1igL6CvQL7CwBAGZQBBGYqgGSQqfGSv1CgQniBMmqAAQnUAAmQhcg");
	var mask_graphics_109 = new cjs.Graphics().p("A5TSoQr7iwhAmZQhBmYKfmSQKgmRP1igQP1igL6CvQL7CwBAGZQBBGYqgGSQqfGSv1CgQniBMmqAAQnUAAmPhcg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(105).to({graphics:mask_graphics_105,x:-252.6,y:152.3}).wait(1).to({graphics:mask_graphics_106,x:-181.1,y:146.3}).wait(1).to({graphics:mask_graphics_107,x:-102.1,y:140.4}).wait(1).to({graphics:mask_graphics_108,x:-23.2,y:134.4}).wait(1).to({graphics:mask_graphics_109,x:55.7,y:128.4}).wait(153));

	// 圖層 7
	this.instance_7 = new lib.補間動畫6("synched",0);
	this.instance_7.parent = this;
	this.instance_7.setTransform(87,147.1,0.694,0.694,4.7,0,0,0.1,0.1);
	...
	this.instance_8.setTransform(108,34.1,0.541,0.541,0,0,0,300,59);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(50).to({_off:false},0).to({regX:300.3,regY:59.1,scaleX:0.35,scaleY:0.35,x:107.9,y:39.6},5,cjs.Ease.quadInOut).to({regX:300.1,regY:59,scaleX:0.37,scaleY:0.37,y:39.2},3,cjs.Ease.quadInOut).wait(36).to({regX:300.2,regY:59.1,x:108,alpha:0.129},6,cjs.Ease.quadInOut).to({regX:300.1,regY:59,x:107.9,alpha:0},2).to({_off:true},1).wait(159));

	// 圖層 5
	this.instance_9 = new lib.元件24();
	this.instance_9.parent = this;
	this.instance_9.setTransform(97.6,123.3,0.786,0.786,0,0,0,118.6,40.6);
	...
	this.instance_10.setTransform(47.9,149.8,0.874,0.874,-120,0,0,25.2,34.8);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(56).to({_off:false},0).to({regX:25.3,scaleX:1.07,scaleY:1.07,x:43.9,y:145.1,alpha:1},10,cjs.Ease.quadOut).wait(30).to({x:51.8,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 8
	this.instance_11 = new lib.元件60();
	this.instance_11.parent = this;
	this.instance_11.setTransform(103.4,153.1,0.786,0.786,0,0,0,112,89.5);
	this.instance_11.alpha = 0;
	this.instance_11._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).wait(48).to({_off:false},0).to({regX:112.1,x:111.3,alpha:1},11,cjs.Ease.quadOut).wait(37).to({x:119.2,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 9
	this.instance_12 = new lib.元件61();
	this.instance_12.parent = this;
	this.instance_12.setTransform(81.4,140.3,0.786,0.786,0,0,0,93,94);
	this.instance_12.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).to({x:89.3,alpha:1},11,cjs.Ease.quadOut).wait(27).to({x:112.8,alpha:0},11,cjs.Ease.quadIn).to({_off:true},1).wait(212));

	// t1.png
	this.instance_13 = new lib.元件2();
	this.instance_13.parent = this;
	this.instance_13.setTransform(99.9,36.4,1.091,1.091,0,0,0,118.5,26.1);
	this.instance_13._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(4).to({_off:false},0).to({regX:118.6,scaleX:0.75,scaleY:0.75,x:100,y:40.3},8,cjs.Ease.quadInOut).to({scaleX:0.8,scaleY:0.8,y:39.7},5,cjs.Ease.quadInOut).to({scaleX:0.79,scaleY:0.79,y:39.9},4,cjs.Ease.quadInOut).wait(16).to({scaleX:0.59,scaleY:0.59,x:99.9,y:42.1,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(212));

	// bg
	this.instance_14 = new lib.元件55();
	this.instance_14.parent = this;
	this.instance_14.setTransform(100.3,98.7,0.786,0.85,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_14).wait(262));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(82.5,92.5,235.7,221.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/200x200_atlas_.png?1539764586481", id:"200x200_atlas_"}
	],
	preloads: []
};
