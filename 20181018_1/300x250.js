...
(lib._300x250 = function(mode,startPosition,loop) {
	...
	this.instance_11.setTransform(127,178,1,1,0,0,0,93,94);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:137,alpha:1},11,cjs.Ease.quadOut).wait(27).to({x:167,alpha:0},11,cjs.Ease.quadIn).to({_off:true},1).wait(212));

	// t1.png
	this.instance_12 = new lib.元件2();
	this.instance_12.parent = this;
	this.instance_12.setTransform(150.6,45.7,1.389,1.389,0,0,0,118.5,26.1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/300x250_atlas_.png?1539762119364", id:"300x250_atlas_"}
	],
	preloads: []
};
