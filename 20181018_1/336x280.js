...
lib.ssMetadata = [
		{name:"336x280_atlas_", frames: [[328,442,139,131],[171,442,155,121],[0,433,169,124],[0,0,403,250],[405,99,43,43],[405,0,42,64],[226,252,186,188],[0,252,224,179],[405,66,17,19],[449,47,43,50],[449,0,48,45],[0,559,142,40]]}
];
...
(lib.元件33 = function(mode,startPosition,loop) {
	...
	// 圖層 3
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(92.1,16.9);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件33, new cjs.Rectangle(0.1,-2.9,184,39.7), null);
...
(lib.元件61 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(221.6,140.1,0.159,0.159,0,0,0,178.5,127.7);
...
}).prototype = getMCSymbolPrototype(lib.元件61, new cjs.Rectangle(0,0,250,188), null);
...
(lib.元件59 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(113.3,18.3,1,1,0,0,0,123.9,18.3);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件59, new cjs.Rectangle(-10.6,0,247.8,36.5), null);
...
(lib.元件34 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(123.1,4.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.元件34, new cjs.Rectangle(0.1,-4.1,257.1,63.2), null);
...
(lib._336x280 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(55.9,22.5,1.127,1.127,0,0,0,35.6,6);
	...
	this.instance_1.parent = this;
	this.instance_1.setTransform(273,24.2,0.458,0.458,0,0,0,123.9,18.4);
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(165.7,67,1.127,1.127,0,0,0,92,20);
	this.instance_2.alpha = 0;
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(102).to({_off:false},0).to({y:51.6,alpha:1},7,cjs.Ease.cubicOut).wait(153));

	// t42.png
	this.instance_3 = new lib.元件34();
	this.instance_3.parent = this;
	this.instance_3.setTransform(91.9,133.2,1.127,1.127,0,0,0,61.6,29.6);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(107).to({_off:false},0).to({regY:29.5,y:124.1},7,cjs.Ease.cubicOut).wait(148));

	// p3.png
	this.instance_4 = new lib.元件53();
	this.instance_4.parent = this;
	this.instance_4.setTransform(169.6,187.5,1.675,1.675,0,0,0,111,29.8);
	this.instance_4.alpha = 0;
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(109).to({_off:false},0).to({scaleX:1.13,scaleY:1.13,alpha:1},8,cjs.Ease.cubicOut).wait(145));

	// hand.png
	this.instance_5 = new lib.元件40();
	this.instance_5.parent = this;
	this.instance_5.setTransform(192.7,256.4,1.127,1.127,0,0,0,86,24.5);
	this.instance_5.alpha = 0;
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(111).to({_off:false},0).to({regY:24.6,y:247.4,alpha:1},9,cjs.Ease.cubicOut).wait(142));

	// 圖層 28 (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_105 = new cjs.Graphics().p("EgqkAipQzWkdhpqYQhpqYRCqNQRDqNZvkDQZukETWEdQTXEeBpKXQBpKYxDKNQxCKN5vEEQsPB8q0AAQr5AAqJiWg");
	var mask_graphics_106 = new cjs.Graphics().p("EgpIAhIQzWkdhpqYQhpqYRCqNQRDqNZvkEQZukETWEeQTXEeBpKYQBpKXxDKNQxCKN5vEEQsPB8q0AAQr5AAqJiWg");
	var mask_graphics_107 = new cjs.Graphics().p("EgpIAfnQzWkehpqYQhpqYRCqMQRDqNZvkEQZukETWEeQTXEeBpKYQBpKXxDKNQxCKN5vEEQsPB8q0AAQr5AAqJiWg");
	var mask_graphics_108 = new cjs.Graphics().p("EgpIAeGQzWkehpqYQhpqYRCqMQRDqNZvkEQZukETWEdQTXEeBpKYQBpKXxDKNQxCKO5vEEQsPB7q0AAQr5AAqJiVg");
	var mask_graphics_109 = new cjs.Graphics().p("EgpIAclQzWkehpqYQhpqYRCqMQRDqNZvkEQZukETWEdQTXEeBpKYQBpKXxDKNQxCKO5vEEQsPB7q0AAQr5AAqJiVg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(105).to({graphics:mask_graphics_105,x:-407.7,y:236.7}).wait(1).to({graphics:mask_graphics_106,x:-288.7,y:227}).wait(1).to({graphics:mask_graphics_107,x:-160.5,y:217.3}).wait(1).to({graphics:mask_graphics_108,x:-32.2,y:207.5}).wait(1).to({graphics:mask_graphics_109,x:96,y:197.8}).wait(153));

	// 圖層 7
	this.instance_6 = new lib.補間動畫6("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(146.9,217.4,1.127,1.127,4.7,0,0,0.1,0.1);
	...
	this.instance_7.setTransform(172.1,47.2,0.694,0.694,0,0,0,300.1,59);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(50).to({_off:false},0).to({regX:300.2,scaleX:0.45,scaleY:0.45,x:172,y:54.3},5,cjs.Ease.quadInOut).to({regY:59.1,scaleX:0.47,scaleY:0.47,x:172.1,y:53.9},3,cjs.Ease.quadInOut).wait(36).to({regX:300.4,alpha:0.129},6,cjs.Ease.quadInOut).to({regX:300.2,alpha:0},2).to({_off:true},1).wait(159));

	// 圖層 19
	this.instance_8 = new lib.元件24();
	this.instance_8.parent = this;
	this.instance_8.setTransform(166.2,161.7,1.127,1.127,0,0,0,118.5,40.5);
	...
	this.instance_9.setTransform(95,199.8,1.254,1.254,-120,0,0,25.2,34.8);
	this.instance_9.alpha = 0;
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(56).to({_off:false},0).to({regX:25.3,scaleX:1.53,scaleY:1.53,x:89.3,y:193,alpha:1},10,cjs.Ease.quadOut).wait(30).to({x:100.6,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 9
	this.instance_10 = new lib.元件60();
	this.instance_10.parent = this;
	this.instance_10.setTransform(174.7,204.5,1.127,1.127,0,0,0,112,89.5);
	this.instance_10.alpha = 0;
	this.instance_10._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(48).to({_off:false},0).to({regX:112.1,x:186.1,alpha:1},11,cjs.Ease.quadOut).wait(37).to({x:197.3,alpha:0},8,cjs.Ease.quadIn).to({_off:true},1).wait(157));

	// 圖層 10
	this.instance_11 = new lib.元件61();
	this.instance_11.parent = this;
	this.instance_11.setTransform(143.1,200.6,1.127,1.127,0,0,0,93,94);
	this.instance_11.alpha = 0;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({x:154.4,alpha:1},11,cjs.Ease.quadOut).wait(27).to({x:188.2,alpha:0},11,cjs.Ease.quadIn).to({_off:true},1).wait(212));

	// t1.png
	this.instance_12 = new lib.元件2();
	this.instance_12.parent = this;
	this.instance_12.setTransform(169.7,51.5,1.565,1.565,0,0,0,118.5,26.1);
	this.instance_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(4).to({_off:false},0).to({scaleX:1.07,scaleY:1.07,x:169.6,y:57.1},8,cjs.Ease.quadInOut).to({regY:26,scaleX:1.15,scaleY:1.15,y:56.1},5,cjs.Ease.quadInOut).to({regY:26.1,scaleX:1.13,scaleY:1.13,y:56.4},4,cjs.Ease.quadInOut).wait(16).to({regY:26,scaleX:0.84,scaleY:0.84,y:59.7,alpha:0},12,cjs.Ease.cubicIn).to({_off:true},1).wait(212));

	// bg
	this.instance_13 = new lib.元件55();
	this.instance_13.parent = this;
	this.instance_13.setTransform(169.1,140.9,1.127,1.127,0,0,0,150,125);

	this.timeline.addTween(cjs.Tween.get(this.instance_13).wait(262));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(168,140,338.1,306.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/336x280_atlas_.png?1539764253368", id:"336x280_atlas_"}
	],
	preloads: []
};
